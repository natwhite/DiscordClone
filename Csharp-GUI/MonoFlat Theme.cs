...
//TODO: Figure out why tooltips arent working correctly
...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        Color DiscordLightGray = Color.FromArgb(72, 75, 81);
        Color DiscordGray = Color.FromArgb(54, 57, 63);
        Color DiscordDarkGray = Color.FromArgb(47, 49, 54);
        Color DiscordDarkerGray = Color.FromArgb(40, 43, 48);
        Color DiscordDarkestGray = Color.FromArgb(32, 34, 37);
        Color DiscordBottomLeftBarGray = Color.FromArgb(42, 44, 49);
        Color DiscordRed = Color.FromArgb(240, 71, 71);
        ...
        {
            base.CreateHandle();
           // ParentForm.bound Load. Screen.FromHandle(Parent.FindForm().Handle).WorkingArea;
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //Top Bar
            //Caption Bar
            G.FillRectangle(new SolidBrush(Color.FromArgb(32, 34, 37)), new Rectangle(0, 0, Width, 22));

            //Top Horizontal Right Second Bar Gray
            G.FillRectangle(new SolidBrush(Color.FromArgb(54, 57, 63)), new Rectangle(310, 22, Width, 48));

            //Top Horizontal Left Second Bar Dark Gray Left
            G.FillRectangle(new SolidBrush(Color.FromArgb(47, 49, 54)), new Rectangle(0, 22, 312, Height));

            //Bottom Left Darker Gray Bar
            G.FillRectangle(new SolidBrush(Color.FromArgb(42, 44, 49)), new Rectangle(0, Height - 53, 312, 52));

            //Separating line
            G.FillRectangle(new SolidBrush(Color.FromArgb(35, 37, 41)), new Rectangle(30, 70, Width, 1));

            //Left Vertical Darkest Gray Bar
            G.FillRectangle(new SolidBrush(Color.FromArgb(32, 34, 37)), new Rectangle(0, 0, 70, Height));


            //RoundCorner Settings
            if (_RoundCorners == true)
            {
                ...
                ////Back Color
                //G.FillRectangle(new SolidBrush(DiscordGray), Width - 2, Height - 3, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), Width - 2, Height - 4, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), Width - 4, Height - 2, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), Width - 3, Height - 2, 1, 1);

                //G.FillRectangle(new SolidBrush(DiscordGray), 1, Height - 3, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), 1, Height - 4, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), 3, Height - 2, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), 2, Height - 2, 1, 1);
                //G.FillRectangle(new SolidBrush(DiscordGray), 2, Height - 2, 1, 1);
            }
    ...
    class MonoFlat_ControlBox : Control
    {
        ...
        [
        Category("Appearance"),
        Description("Determines whether a form has a maximize box in the upper-right corner of it's caption bar.")
        ]
        ...
        [
        Category("Appearance"),
        Description("Determines whether a form has a minimize box in the upper-right corner of it's caption bar.")
        ]
            ...
            switch (ButtonHState)
            {
                ...
                case ButtonHoverState.Maximize:
                    if (_EnableMaximize == true)
                    {
                        ...
                        {
                            //TODO: Fix Maximize Mode
                            //Parent.FindForm().Bounds = Screen.PrimaryScreen.WorkingArea;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            String MaximizeCharacter = "□";
            String MinimizeCharacter = "­–";
            Color HighlightColor = Color.White;
            Color Color1 = Color.FromArgb(166, 167, 168);
            Color Color2 = Color.FromArgb(166, 167, 168);
            Color Color3 = Color.FromArgb(166, 167, 168);
            ...
            if (_EnableHoverHighlight == true)
            {
                switch (ButtonHState)
                {
                    case ButtonHoverState.None:
                        ...
                        break;
                    case ButtonHoverState.Close:
                        G.FillRectangle(new SolidBrush(Color.FromArgb(240, 71, 71)), new Rectangle(Width * 2/3, 0, Size.Width, Height));
                        Color1 = HighlightColor;
                        break;
                    case ButtonHoverState.Maximize:
                        if (_EnableMaximize == true)
                        {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(47, 49, 54)), new Rectangle(Width/3, 0, Size.Width/3, Height));
                    ...
                    case ButtonHoverState.Minimize:
                        if (_EnableMinimize == true)
                        {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(47, 49, 54)), new Rectangle(0, 0, Width/3, Height));
            ...
            //Draws the Close Icon
            G.DrawString(CloseCharacter, Font, new SolidBrush(Color1), Width * 5/6, Y, centered);

            //Draws the Maximize Icon
            //Enabled Button Color
            //Disabled Button Color
            switch (Parent.FindForm().WindowState)
            {
                case FormWindowState.Maximized:
                    if (_EnableMaximize == true)
                    {
                        G.DrawString(MaximizeCharacter, Font, new SolidBrush(Color2), Width/2, Y + 2, centered);
                    }
                    else
                    {
                        G.DrawString(MaximizeCharacter, Font, new SolidBrush(Color.Transparent), Width/2, Y + 2, centered);
                    }
                    break;
            ...
            if (_EnableMinimize == true)
            {
                G.DrawString(MinimizeCharacter, Font, new SolidBrush(Color3), Width/6, Y, centered);
            }
            else
            {
                G.DrawString(MinimizeCharacter, Font, new SolidBrush(Color.Transparent), Width/6, Y, centered);
            }
        }
    }
    ...
    public class MonoFlat_Button : Control
    {
        ...
        [
        Category("Appearance"),
        Description("Specifies the alignment of the image on the control.")
        ]
        ...
        /*public override Color MouseDownColor
        {
            get
            {
                return this._MouseDownColor;
            }
            set
            {
        ...
        public MonoFlat_Button()
        {
            ...
            P1 = new Pen(Color.FromArgb(47, 49, 54)); // P1 = Border color
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(47, 49, 54), Color.FromArgb(47, 49, 54), 90.0F);
